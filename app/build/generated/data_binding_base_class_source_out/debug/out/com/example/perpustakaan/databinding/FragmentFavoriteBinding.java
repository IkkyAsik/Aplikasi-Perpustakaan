...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  private FragmentFavoriteBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout layoutEmpty,
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoriteBinding((LinearLayout) rootView, layoutEmpty, rvFavorites);
    }
